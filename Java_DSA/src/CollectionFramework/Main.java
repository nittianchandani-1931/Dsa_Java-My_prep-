...
public class Main {
    public static void main(String[] args) {
        ...
        stck.push(199);
        System.out.println("Printing stack after push: " + stck);
        ...
        stck.pop();
        System.out.println("Printing stack after pop: " + stck);

        System.out.println("Printing stack peek: " + stck.peek());

        System.out.println(stck.search(199));
